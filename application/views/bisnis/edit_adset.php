...
<form action="<?php echo site_url('bisnis/update_adset') ?>" method="POST">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      ...
      <input type="text" class="form-control" value="<?php echo $key['id_adset'] ?>" name="id_adset" hidden>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Bussines Name <NOFRAMES></NOFRAMES></label>
    <div class="col-sm-4">
      <input type="text" name="nama_bisnis" id="nama_bisnis" class="form-control form-control-sm" placeholder="Nama Bisnis" value="<?php echo $key['nama_bisnis'] ?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Adset Name <NOFRAMES></NOFRAMES></label>
    <div class="col-sm-4">
      <input type="text" name="nama_adset" class="form-control form-control-sm" value="<?php echo $key['nama_adset'] ?>" placeholder="Nama Adset" required>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Headline <NOFRAMES></NOFRAMES></label>
    <div class="col-sm-4">
      <input type="text" name="judul" id="judul" class="form-control form-control-sm" value="<?php echo $key['judul'] ?>" placeholder="Headline..." required>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Description <NOFRAMES></NOFRAMES></label>
    <div class="col-sm-4">
      <textarea name="deskripsi" id="deskripsi" class="form-control"  placeholder="..." required><?php echo $key['deskripsi']; ?></textarea>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label col-form-label-sm text-right">URL target <NOFRAMES></NOFRAMES></label>
    <div class="col-sm-4">
      <input type="text" name="url"  id="url" class="form-control form-control-sm" value="<?php echo $key['url'] ?>" placeholder="contoh: http://www.google.com" required>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <div class="card w-125">
        <div class="card-body">
          ...
          <a href="#" class="btn"><i class="fa fa-external-link" aria-hidden="true"></i> Visit at <strong id="url_preview"><?php echo $key['url'] ?></strong></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-group row">
	  <label class="col-sm-2 col-form-label col-form-label-sm text-right">Cost per Click (CPC)<NOFRAMES></NOFRAMES></label>
	    <div class="col-sm-4">
	      <input type="number" name="cpc" class="form-control form-control-sm" value="<?php echo $key['cpc'] ?>" placeholder="Rp. 500" min="500" readonly>
	    </div>
	</div>
  <?php endforeach ?>
  <div class="form-group row">
